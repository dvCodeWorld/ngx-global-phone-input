    ...
    return (control: AbstractControl): ValidationErrors | null => {
        ...
        try {
            ...
            if (phoneNumberString.startsWith('+')) {
                ...
                phoneNumber = phoneUtil.parse(phoneNumberString, undefined);
            } else {
    ...
    providers: [
        {
            ...
            useExisting: forwardRef(() => GlobalPhoneInputComponent),
            multi: true
        },
        {
          provide: NG_VALIDATORS,
          useExisting: forwardRef(() => GlobalPhoneInputComponent), // Referencing your component
          multi: true // Essential for registering multiple validators
        }
    ],
    
    templateUrl: './global-phone-input.component.html',
    styleUrls: ['./global-phone-input.component.css']
})
export class GlobalPhoneInputComponent implements OnInit, OnDestroy, ControlValueAccessor, Validator {
    ...
    constructor(
        private globalPhoneInputService: GlobalPhoneInputService
    ) {}
    ...
    public clearGeolocationCache(): void {
        this.globalPhoneInputService.clearCache();
    }
        ...
        this.globalPhoneInputService.getCountryData()
            ...
            .subscribe(location => {
                ...
                if (location && location.countryCode && !this.mobileControl.value) {
                    const dialCode = this.globalPhoneInputService.mapCountryCodeToDialCode(location.countryCode);
                    if (dialCode) {
